    ...
    return (
        <div className='flex mt-20 gap-4'>
            <div className=' grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-8 md:gap-4 xl:gap-10 space-y-2'>
                <div className='bg-samsung-1 bg-center bg-cover  rounded-md'>
                    <div className='flex flex-col justify-center items-center bg-black/40 h-full p-2 rounded-md gap-4'>
                        <h2 className='text-[27px] font-bold text-white text-center'>Samsung Products</h2>
                        <p className='text-gray-200 font-medium text-center'>Experience Samsung’s latest innovations across smart devices, home tech, and stunning displays</p>
